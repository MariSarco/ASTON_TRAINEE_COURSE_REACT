    ...
    return (isAuth?
        <header>
            <div className='container py-3 mx-auto px-4 min-h-16 flex flex-col sm:flex-row gap-4 justify-between items-center text-white'>
                ...
                <nav className="flex items-center gap-2">
                    <NavLink to="/favorites" className="bg-transparent hover:bg-white font-semibold hover:text-amber-500 py-1 px-2 border border-white hover:border-transparent rounded">
                        Favorites
                    </NavLink>
        ...
        <header>
            <div className='container py-3 mx-auto px-4 min-h-16 flex flex-col sm:flex-row gap-4 justify-between items-center text-white'>
                ...
                <nav className="flex items-center gap-2">
                    <NavLink to="/signin" className="bg-transparent hover:bg-white text-white font-semibold hover:text-amber-500 py-1 px-2 border border-white hover:border-transparent rounded">
                        LogIn
                    </NavLink>
                    <NavLink to="/signup" className="bg-amber-500 border border-amber-500 hover:bg-amber-600 text-white font-bold py-1 px-2 rounded">
                        SignUp
                    </NavLink>
                </nav>
            </div>
